...
import (
	...
	"github.com/proepkes/speeddate/storagesvc"
	repositorysvr "github.com/proepkes/speeddate/storagesvc/gen/http/repository/server"
	swaggersvr "github.com/proepkes/speeddate/storagesvc/gen/http/swagger/server"
...
func main() {
	...
	{
		var err error
		repositorySvc, err = storagesvc.NewRepository(db, logger)
		if err != nil {
