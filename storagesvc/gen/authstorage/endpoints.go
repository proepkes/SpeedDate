...
// Endpoints wraps the "authstorage" service endpoints.
...
// NewEndpoints wraps the methods of the "authstorage" service with endpoints.
...
// Use applies the given middleware to all the "authstorage" service endpoints.
