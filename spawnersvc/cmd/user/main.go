...
import (
	...
	gamehostsvc "."
	repositorysvr "github.com/proepkes/speeddate/gamehostsvc/gen/http/repository/server"
	swaggersvr "github.com/proepkes/speeddate/gamehostsvc/gen/http/swagger/server"
...
func main() {
	...
	{
		logger = log.New(os.Stderr, "[gamehostsvc] ", log.Ltime)
	...
	{
		repositorySvc = gamehostsvc.NewRepository(logger)
	}
