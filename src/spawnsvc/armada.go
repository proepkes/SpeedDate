...
import (
	...
	"github.com/proepkes/speeddate/src/spawnsvc/gen/armada"
...
func NewArmada(kubeclientset kubernetes.Interface,
	sampleclientset clientset.Interface,
	deploymentInformer appsinformers.DeploymentInformer,
	gameServerInformer informers.GameServerInformer) armada.Service {
...
func (c *armadaSvc) Run(threadiness int, stopCh <-chan struct{}) error {
	...
	if ok := cache.WaitForCacheSync(stopCh, c.deploymentsSynced, c.gameServersSynced); !ok {
...
func (c *armadaSvc) processNextWorkItem() bool {
...
func (c *armadaSvc) syncHandler(key string) error {
...
func (c *armadaSvc) updateFooStatus(foo *samplev1alpha1.Foo, deployment *appsv1.Deployment) error {
...
func (s *armadaSvc) enqueueGameServer(obj interface{}) {
	var key string
	var err error
...
func (s *armadaSvc) handleObject(obj interface{}) {
