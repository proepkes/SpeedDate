...
import (
	...
	scheme "github.com/proepkes/speeddate/src/spawnsvc/pkg/client/clientset/versioned/scheme"
...
func newGameServers(c *SpeeddateV1alpha1Client, namespace string) *gameServers {
	return &gameServers{
		client: c.RESTClient(),
		ns:     namespace,
	}
