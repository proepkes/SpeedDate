...
import (
	...
	devv1alpha1 "github.com/proepkes/speeddate/src/spawnsvc/pkg/apis/dev/v1alpha1"
	...
	v1alpha1 "github.com/proepkes/speeddate/src/spawnsvc/pkg/client/listers/dev/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SpeeddateV1alpha1().GameServers(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SpeeddateV1alpha1().GameServers(namespace).Watch(options)
			},
		},
		&devv1alpha1.GameServer{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *gameServerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&devv1alpha1.GameServer{}, f.defaultInformer)
}
