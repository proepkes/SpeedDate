...
var gameserversResource = schema.GroupVersionResource{Group: "dev", Version: "v1", Resource: "gameservers"}

var gameserversKind = schema.GroupVersionKind{Group: "dev", Version: "v1", Kind: "GameServer"}
