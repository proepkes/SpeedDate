...
//
// authstorage HTTP server encoders and decoders
//
// Command:
...
// DecodeInsertRequest returns a decoder for requests sent to the authstorage
// insert endpoint.
func DecodeInsertRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (interface{}, error) {
	return func(r *http.Request) (interface{}, error) {
		...
		payload := NewInsertAuthUser(&body)
...
// DecodeDeleteRequest returns a decoder for requests sent to the authstorage
// delete endpoint.
...
// authstorage get endpoint.
func EncodeGetResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, interface{}) error {
	return func(ctx context.Context, w http.ResponseWriter, v interface{}) error {
		res := v.(*authstorageviews.StoredUser)
...
// DecodeGetRequest returns a decoder for requests sent to the authstorage get
// endpoint.
...
// EncodeGetError returns an encoder for errors returned by the get authstorage
// endpoint.
