...
import (
	...
	authc "github.com/proepkes/speeddate/authsvc/gen/http/auth/client"
	goa "goa.design/goa"
...
func UsageExamples() string {
	return os.Args[0] + ` auth login --username "user" --password "password"` + "\n" +
		""
}
...
func ParseEndpoint(
	...
	var (
		...
		authLoginUsernameFlag = authLoginFlags.String("username", "REQUIRED", "Username used to perform signin")
		authLoginPasswordFlag = authLoginFlags.String("password", "REQUIRED", "Password used to perform signin")
	)
...
func authLoginUsage() {
	fmt.Fprintf(os.Stderr, `%s [flags] auth login -username STRING -password STRING
...
Example:
    `+os.Args[0]+` auth login --username "user" --password "password"
`, os.Args[0])
}
