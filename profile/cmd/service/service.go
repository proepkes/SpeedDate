...
import (
	...
	endpoint "github.com/proepkes/SpeedDate/profile/pkg/endpoint"
	http "github.com/proepkes/SpeedDate/profile/pkg/http"
...
var fs = flag.NewFlagSet("profile", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "profile")
